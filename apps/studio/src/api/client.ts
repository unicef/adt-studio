...
export const api = {
  ...
  getGitHubSpeechSuggestions: (label: string) => request<{ source: "working-tree" | "latest-deployment" | "none"; items: Array<{ textId: string; files: string[] }> }>(`/books/${label}/github-publishing/speech-suggestions`),
