...
export const api = {
  ...
  generatePersonalizedMaterial: (studentId: string, sourceBookLabel: string, profileId?: string) => request<{ material: { id: string; derivedBookLabel: string }; assignment: MaterialAssignment; plan: { rules: Record<string, boolean> } }>("/materials/personalized", { method: "POST", body: JSON.stringify({ studentId, sourceBookLabel, profileId }) }),
