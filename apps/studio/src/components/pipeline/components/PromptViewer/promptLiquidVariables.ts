...
const PROMPT_VARIABLES: Record<string, string[]> = {
  ...
  image_meaningfulness_storybook: IMAGE_FILTER_VARIABLES,
  ...
  web_generation_storybook_html: RENDER_PROMPT_VARIABLES,
  web_generation_textbook_html_overlay: RENDER_PROMPT_VARIABLES,
  textbook_geometry_plan: [
    "page_image_base64",
    "section_type",
    "nodes",
