...
export type PipelineStageSlug = Exclude<StageSlug, "book" | "sign-language" | "validation" | "publish" | "export">
...
export function isPipelineStage(stage: StageDefinition): stage is PipelineStageDefinition {
  return stage.slug !== "book" && stage.slug !== "sign-language" && stage.slug !== "validation" && stage.slug !== "publish" && stage.slug !== "export"
}
