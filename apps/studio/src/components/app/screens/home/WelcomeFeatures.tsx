...
export function WelcomeFeatures() {
  return (
    <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
      <div className="flex flex-col justify-center">
        ...
        <h2 className="mt-2.5 text-[36px] font-bold leading-[1.05] tracking-[-0.025em]">
