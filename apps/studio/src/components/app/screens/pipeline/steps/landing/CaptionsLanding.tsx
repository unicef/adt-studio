...
import {
  CaptionsPreview,
  type GradeLevelKey,
} from "@/components/pipeline/stages/captions/components/CaptionsPreview"
...
export function CaptionsLanding({ bookLabel, beforeRun }: { bookLabel: string; beforeRun?: ReactNode }) {
  const { t } = useLingui()
