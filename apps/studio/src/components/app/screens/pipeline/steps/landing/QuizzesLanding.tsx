...
import { QuizzesPreview } from "@/components/pipeline/stages/quizzes/components/QuizzesPreview"
...
export function QuizzesLanding({ bookLabel, beforeRun }: { bookLabel: string; beforeRun?: ReactNode }) {
  const { t } = useLingui()
