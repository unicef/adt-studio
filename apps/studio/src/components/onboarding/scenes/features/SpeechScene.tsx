...
function SpeechDemo() {
  ...
  return (
    <div className="relative h-[280px] w-[300px] rounded-2xl bg-white p-5 shadow-[0_18px_44px_-12px_rgba(6,20,60,0.45)]">
      ...
      <div className="absolute inset-x-5 bottom-5 flex items-center gap-3 rounded-xl bg-[var(--ob-accent-wash)] px-3 py-2.5">
        <div className="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-[var(--ob-accent)]">
      ...
      <DemoCursor x={cursor.x} y={cursor.y} clicking={clicking} color={OB_ACCENT} />
    </div>
  )
}
