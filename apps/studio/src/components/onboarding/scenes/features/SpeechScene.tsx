  ...
  return (
    <div className="relative h-[280px] w-[300px] rounded-2xl bg-white p-5 shadow-[0_18px_44px_-12px_rgba(6,20,60,0.45)]">
      ...
      <div className="mt-3.5 space-y-2.5">
        ...
        <div
          className={cn("h-[6px] rounded-full transition-colors duration-300", played ? "bg-[#a9c8ff]" : "bg-[#eef0f4]")}
          style={{ width: "66%" }}
        />
      </div>
      ...
      <DemoCursor x={cursor.x} y={cursor.y} clicking={clicking} color="#3b82f7" />
    </div>
  )
}
