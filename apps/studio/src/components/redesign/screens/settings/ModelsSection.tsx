    ...
    <>
      ...
      >
        ...
        <div className="flex flex-wrap items-end gap-3 px-[18px] pb-[18px] pt-4">
          <div className="min-w-[240px] flex-1">
            <label htmlFor="redesign-default-model" className="mb-1.5 block text-[12.5px] font-medium">
              <Trans>LLM model</Trans>
            </label>
            <ModelSelect
              inputId="redesign-default-model"
              value={llm.draft}
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <SpecializedCard
          ...
          inputId="redesign-image-generation-model"
        ...
        <SpecializedCard
          ...
          inputId="redesign-speech-generation-model"
