...
import {
  GlossaryPreview,
  type AmountKey,
} from "@/components/pipeline/stages/glossary/components/GlossaryPreview"
import { AmountRow, AMOUNT_OPTIONS } from "@/components/pipeline/stages/glossary/components/AmountRow"
import { SeedTermRow } from "@/components/pipeline/stages/glossary/components/SeedTermRow"

export function GlossaryLanding({ bookLabel, beforeRun }: { bookLabel: string; beforeRun?: ReactNode }) {
  const { t } = useLingui()
