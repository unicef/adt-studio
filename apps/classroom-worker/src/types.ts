...
export interface Material { id: string; teacherId: string; studentId: string | null; title: string; body: string; r2Key: string | null; syncStatus: SyncStatus; r2UploadedAt: string | null; syncError: string | null; createdAt: string; updatedAt: string }
