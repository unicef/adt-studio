...
- **Scanned or image-based PDFs** — a scan is a photograph of a page, with no text layer. ADT Studio cannot extract readable text from it the way it can from a real text-layer PDF.
