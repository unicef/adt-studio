...
The next page, [Extract content](/docs/convert-pdf/extract), walks you through configuring — and then running — the extraction. If you already have an API key saved when you select **Create ADT**, extraction (and an initial pass of sectioning) starts automatically, and you'll land on your book with that work already underway.
