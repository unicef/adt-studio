// Vendored from beui.dev/components/motion/text-animation, adapted for this
// app's cn helper and shared ease tokens. Word or character reveal with
// spring slide-up and blur.
...
export function TextReveal({
  ...
  return (
    // The split spans read choppily in some screen readers, so the container
    // carries the full text and the animated fragments are decorative.
    <Comp
      ref={ref}
    ...
    >
      {lines.map((line) => {
        ...
        return (
          <span key={lineKey} className="block" aria-hidden>
            {units.map((unit, i) => {
