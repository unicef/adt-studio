...
/**
 * Cross-scene contract: dispatch this CustomEvent (detail: { key }) to make
 * the demo scene scroll into view and activate the given demo. Used by
 * feature cards' "watch" affordances.
 */
export const DEMO_SELECT_EVENT = "adt:select-demo";

export function selectDemo(key: string): void {
  document.dispatchEvent(
    new CustomEvent(DEMO_SELECT_EVENT, { detail: { key } }),
  );
}
