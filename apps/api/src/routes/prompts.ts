...
import { AppConfig, DEFAULT_BASE_PROMPT_MODEL_ID, safeParseModelId, parseBookLabel } from "@adt/types"
...
export function createPromptRoutes(
  ...
  booksDir: string,
  configPath?: string,
  promptOverridesDir: string = path.join(booksDir, ".adt-studio", "prompt-overrides"),
) {
  const app = new Hono()
