...
export const COMMENT_STRINGS = {
  ...
  "comments-presence-open-label": "See who is reading",
  "comments-presence-close-label": "Close the reader list",
  "comments-presence-title-label": "Reading right now",
  "comments-cursor-offscreen-label": "Go to ${name}, further ${direction}",
  "comments-cursor-direction-up-label": "up",
  "comments-cursor-direction-down-label": "down",
  ...
  "comments-hidden-toast-label": "Comments hidden. Turn them back on in the dock.",
  "comments-device-preview-label": "Preview as",
