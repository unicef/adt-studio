...
export const DEFAULT_TYPOGRAPHY: BookTypography = {
  styles: [
    ...
    { key: "heading_level_4", label: "Heading level 4", className: "adt-h4", desktopPx: 28, mobilePx: 19 },
    { key: "heading_level_5", label: "Heading level 5", className: "adt-h5", desktopPx: 26, mobilePx: 18 },
    { key: "heading_level_6", label: "Heading level 6", className: "adt-h6", desktopPx: 24, mobilePx: 17 },
