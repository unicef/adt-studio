...
export const PIPELINE: StageDef[] = [
  {
    ...
    steps: [
      ...
      { name: "image-classification", label: "Image Classification", dependsOn: ["extract"] },
      { name: "image-cropping", label: "Image Cropping", dependsOn: ["image-classification"] },
      { name: "image-meaningfulness", label: "Image Filtering", dependsOn: ["image-classification"] },
